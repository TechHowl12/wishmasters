...
const PrivacyPolicy = () => {
  return (
    <div className="bg-[#1D2123] text-white p-3 sm:p-10 border-b">
      <h1 className="text-3xl font-semibold mt-5 sm:mt-0">Terms & Condition</h1>
      ...
      <h1 className="text-3xl font-semibold mt-5 border-t pt-5">Privacy Policy</h1>
      <p className="text-xs tracking-wide mt-5 leading-5">
        ...
        in the manner as may be required under applicable laws.<br/><br/> Grievance
        Officer: Manjot Singh <br/><br/>Designation: Ground Floor, Plot 37, Mahalaxmi Building,
        Bora Bazar, Fort - Mumbai 400001  <br/><br/>Contact us: +91 8419911616 <br/><br/>Time: Monday - Friday(9:00 - 18:00)
      </p>
      <h1 className="text-3xl font-semibold mt-5 border-t pt-5">Refund and Cancellation policy</h1>
      <p className="text-xs tracking-wide mt-5 leading-5">
