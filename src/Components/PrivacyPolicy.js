...
const PrivacyPolicy = () => {
  ...
  const termsText = `
    ...
    www.wishmasters.in ('Website'), including the related mobile site and
    mobile application (hereinafter referred to as 'Platform'). The Platform
    is owned by WISHMASTERS GAMING TECHNOLOGIES PRIVATE LIMITED, a company
    incorporated under the Companies Act, 1956 with its registered office at
    1, FLOOR GRD, PLOT NO 37, MAHALUXMI BUILDING, Pitha Street MARUTI LANE
    BORA BAZAAR STREET, Narmada Stationery, Mumbai Fort ,Mumbai ,India
    ...
    provide true, accurate and complete information to us during and after
    registration, and you shall be responsible for all acts done through the
    use of your registered account on the Platform.. Neither we nor any
  ...
  const privacyText = `
       Introduction This Privacy Policy describes how WISHMASTERS GAMING
        TECHNOLOGIES PRIVATE LIMITED and its affiliates (collectively
        &quot;WISHMASTERS GAMING TECHNOLOGIES PRIVATE LIMITED, we, our,
        us&quot;) collect, use, share, protect or otherwise process your
        information/ personal data through our website www.wishmasters.in
        (hereinafter referred to as Platform). Please note that you may be able
        to browse certain sections of the Platform without registering with
        us.We do not offer any product/service under this Platform outside India
        ...
        not use or access our Platform. Collection-We collect your personal data
        when you use our Platform, services or otherwise interact with us during
        the course of our relationship.and related information provided from
        time to time. Some of the information that we may collect includes but
        is not limited to personal data / information provided to us during
        sign-up/registering or using our Platform such as name, date of birth,
        address, telephone/mobile number, email IDand/or any such information
        shared as proof of identity or address. Some of the sensitive personal
        data may be collected with your consent, such as your bank account or
        ...
        information (in order to enable use of certain features when opted for,
        available on the Platform) etc all of the above being in accordance with
        applicable law(s) You always have the option to not provide information,
        ...
        person/association claiming to be WISHMASTERS GAMING TECHNOLOGIES
        PRIVATE LIMITED seeking any personal data like debit/credit card PIN,
        net-banking or mobile banking password, we request you to never provide
        such information. If you have already revealed such information, report
        it immediately to an appropriate law enforcement agency. Usage- We use
  ...
  return (
    <div className="bg-[#1D2123] text-white p-3 sm:p-10 border-b">
      <h2 className="text-3xl font-semibold mt-5 sm:mt-0">
        Terms and Conditions
      </h2>
      <p className="text-xs tracking-wide mt-5 leading-5">
        {isTermsExpanded ? termsText : `${termsText.substring(0, 900)}...`}
        <button className="text-blue-500" onClick={toggleTerms}>
          {isTermsExpanded ? "Read Less" : "Read More"}
        </button>
      </p>

      <h2 className="text-3xl font-semibold mt-5 pt-5 border-t">
        Privacy Policy
      </h2>
      <p className="text-xs tracking-wide mt-5 leading-5">
        {isPrivacyExpanded
          ? privacyText
          : `${privacyText.substring(0, 900)}...`}
          <button className="text-blue-500" onClick={togglePrivacy}>
          {isPrivacyExpanded ? "Read Less" : "Read More"}
        </button>
        <span>
        <br /><br />Grievance Officer: Manjot Singh <br />
          <br />
          Designation: Ground Floor, Plot 37, Mahalaxmi Building, Bora Bazar,
          Fort - Mumbai 400001 <br />
          <br />
          Contact us: +91 8419911616 <br />
          <br />
          Time: Monday - Friday(9:00 - 18:00)
        </span>
      </p>
      <h1 className="text-3xl font-semibold mt-5 border-t pt-5">
